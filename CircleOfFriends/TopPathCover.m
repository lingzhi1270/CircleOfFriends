...
@property (nonatomic, strong)  WaterDropRefresh*waterDropRefresh;

@property (nonatomic, assign) CGFloat showUserInfoViewOffsetHeight;

@end

@implementation TopPathCover
...
- (void)_setup {
    ...
    _waterDropRefresh = [[WaterDropRefresh alloc] initWithFrame:CGRectMake(33, CGRectGetHeight(self.bounds) - waterDropRefreshHeight, waterDropRefreshWidth, waterDropRefreshHeight)];
...
- (void)initWaterView {
    __weak TopPathCover *wself =self;
